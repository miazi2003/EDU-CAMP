          ...
          <form className="flex  p-4 gap-4">
            ...
            <div className="flex flex-col gap-8 w-full">
              ...
              <div className="flex justify-between items-center">
                <select name="" id="" className="border border-green-800 mt-2 w-max h-8">
                  <option disabled value="Set A Difficulty">Set A Difficulty</option>
                  <option value="Easy">Easy</option>
                  <option value="Normal">Normal</option>
                  <option value="Hard">Hard</option>
                </select>
                <div className="w-full flex items-center justify-center">
                  <button  type="submit" className="btn h-10 bg-green-800 hover:bg-white hover:text-green-800 hover:border-green-800  text-white duration-300">Create Assignment</button>
                </div>
              </div>
            </div>
          </form>
