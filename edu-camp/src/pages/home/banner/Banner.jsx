...
const Banner = () => {
  return (
    <div className="hero  lg:p-2 md:p-4 p-6 rounded-3xl">
      <div className="hero-content flex-col lg:flex-row-reverse justify-around relative ">
        <div className="clip h-112 w-112 primary overflow-clip relative lg:flex hidden">
        ...
        <div className="absolute h-118 w-102 right-12 bottom-4 lg:flex hidden">
          <img
